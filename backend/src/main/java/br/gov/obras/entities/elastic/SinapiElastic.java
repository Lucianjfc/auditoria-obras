...
@NoArgsConstructor
@AllArgsConstructor
@Document(indexName = "sinapi_index")
public class SinapiElastic {
    ...
    private List<CaracteristicaSinapiElastic> caracteristicasNaoDesonerado;

    @Field(type = FieldType.Nested, name = "CARACTERISTICAS_DESONERADO")
    private List<CaracteristicaSinapiElastic> caracteristicasDesonerado;
