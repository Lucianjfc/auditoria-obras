...
import br.gov.obras.dtos.requests.Page;
import br.gov.obras.dtos.responses.BuscaResponse;
import br.gov.obras.dtos.responses.ReferenciaDTO;
import br.gov.obras.dtos.responses.SicroResponse;
import br.gov.obras.dtos.responses.SinapiResponse;
import br.gov.obras.entities.ItemObra;
import br.gov.obras.entities.elastic.CaracteristicaSicroElastic;
import br.gov.obras.entities.elastic.CaracteristicaSinapiElastic;
...
import br.gov.obras.services.CatalogoObraElasticService;
